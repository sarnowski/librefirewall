...
use crate::catalog::{
    ...
    CONFIGURATION_GENERATION, CONFIGURATION_IMAGES, CONFIGURATION_READS, CONFIGURATION_SUBMISSIONS,
    CONSOLE_RECORDS, CRYPTO_CYCLES_PER_OPERATION, CRYPTO_MILLI_CYCLES_PER_BYTE, CRYPTO_PROVEN,
    CRYPTO_VECTORS, DEVICE_FAULTS, ENDPOINT_BYTES, ENDPOINT_FRAMES, ENDPOINT_MALFORMED,
    ENDPOINT_NOT_FOR_US, ENDPOINT_REPLIES, ENDPOINT_REPLIES_LOST, ENDPOINT_REPLIES_SENT,
    ENDPOINT_REPLY_REFUSED, ENDPOINT_STAGE_DROPS, ENDPOINT_TCP_SEGMENTS, ENDPOINT_TIMER_SEGMENTS,
    ENDPOINT_UNCLOCKED, ENDPOINT_UNHANDLED, FLOW_LIFECYCLE, FLOW_PACKETS, FLOW_PACKETS_REFUSED,
    FLOW_PACKETS_SEEN, FLOW_PROBE_COLLISIONS, FLOW_TABLE_ENTRIES, FORWARDED_FRAMES,
    HARDWARE_PROBE_ITERATIONS, HARDWARE_PROBE_PREEMPTIONS, HARDWARE_PROBE_PROVEN,
