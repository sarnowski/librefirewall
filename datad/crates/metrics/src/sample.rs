...
use crate::catalog::{
    ...
    CONSOLE_RECORDS, CONSOLE_TRANSCRIPT_LINES, CRYPTO_CYCLES_PER_OPERATION,
    ...
    INVARIANT_FAULTS, LOG_RECORDS_DROPPED, LOG_RECORDS_REFUSED, Label, NEIGHBOUR_ENTRIES_EXPIRED,
    NEIGHBOUR_REPLIES, NEIGHBOUR_REQUESTS, NEIGHBOUR_RESOLUTIONS_FAILED, ONBOARD_ANSWERS_REFUSED,
    ONBOARD_BYTES, ONBOARD_CONNECTIONS, ONBOARD_OVERFLOWED, ONBOARD_SESSIONS_CLOSED,
    OUTBOUND_ANSWERS_REFUSED, OUTBOUND_BYTES, OUTBOUND_DIALS, OUTBOUND_OVERFLOWED,
