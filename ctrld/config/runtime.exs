...
#
#     PHX_SERVER=true bin/ctrld start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :ctrld, CtrldWeb.Endpoint, server: true
end
  ...
  config :ctrld, CtrldWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/ctrld_web/router\.ex$",
        ~r"lib/ctrld_web/(controllers|live|components)/.*\.(ex|heex)$"
      ]
    ]
end
...
if config_env() == :prod do
  ...
  config :ctrld, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
